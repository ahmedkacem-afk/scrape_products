...
class Vidange : 
    def __init__(self,search="roulement",page="1"):
        ...
        self.url=lambda page: f"https://auto-pieces.tn/index.php?controller=search&s={search}&page={page}"
    ...
    def search_product(self):
        print("Searching for products in Auto piece site Please wait...")
        ...
        print(f"Product {self.search} with the minimum price in Auto Piece:")
